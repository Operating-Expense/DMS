...
if ( !class_exists( 'DMSShortcode_Form_File_Uploader' ) ) {
	class DMSShortcode_Form_File_Uploader extends Shortcode {
		...
		public function enqueue_scripts() {
			\DMS\Helper\Assets::enqueue_script( 'shortcode-uploader', $this->shortcode_uri.'/assets/uploader.js' );
		}
