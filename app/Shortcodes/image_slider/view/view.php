...
$attributes[] = 'data-num="' . $atts['num'] . '"';
$attributes[] = 'data-num-medium="' . $atts['num_medium'] . '"';
$attributes[] = 'data-num-small="' . $atts['num_small'] . '"';
$attributes[] = 'data-autoplay="' . $atts['autoplay'] . '"';
$attributes[] = 'data-autoplay-speed="' . $atts['autoplay_speed'] . '"';
