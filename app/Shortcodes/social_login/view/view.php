...
$displayed_icons = array(
	'facebook' => \DMS\Helper\Utils::get_option( 'facebook_app_id' ) <> '',
	'twitter'  => \DMS\Helper\Utils::get_option( 'twitter_consumer_key' ) <> '',
	'google'   => \DMS\Helper\Utils::get_option( 'google_client_id' ) <> '',
);
