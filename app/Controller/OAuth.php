...
class OAuth {
	...
	public function auth_facebook() {
		...
		$fb = new \Facebook\Facebook( [
			'app_id'     => \DMS\Helper\Utils::get_option( 'facebook_app_id' ),
			'app_secret' => \DMS\Helper\Utils::get_option( 'facebook_app_secret' ),
		] );
	...
	private function _get_google_client() {
		...
		$client->setAuthConfig( [
			'client_id'     => \DMS\Helper\Utils::get_option( 'google_client_id' ),
			'client_secret' => \DMS\Helper\Utils::get_option( 'google_client_secret' )
		] );
	...
	public function auth_twitter() {
		...
		$connection = new \Abraham\TwitterOAuth\TwitterOAuth(
			\DMS\Helper\Utils::get_option( 'twitter_consumer_key' ),
			\DMS\Helper\Utils::get_option( 'twitter_consumer_secret' )
		);
	...
	public function callback_twitter() {
		...
		$consumer_key    = \DMS\Helper\Utils::get_option( 'twitter_consumer_key' );
		$consumer_secret = \DMS\Helper\Utils::get_option( 'twitter_consumer_secret' );
