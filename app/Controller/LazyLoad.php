...
class LazyLoad {
	...
	public function skip() {
		...
		$img_lazy_load = (int) \DMS\Helper\Utils::get_option( 'img_lazy_load', 0 );
	...
	public function process_image_attributes( $attributes) {
		...
		$image_size['width'] = $min_width = (int) \DMS\Helper\Utils::get_option( 'lazy_img_min_width', 24 );
		$image_size['height'] = $min_height = (int) \DMS\Helper\Utils::get_option( 'lazy_img_min_height', 24 );
		...
		} elseif ( \DMS\Helper\Utils::get_option( 'lazy_load_get_sizes_with_getimagesize', 1 ) ) {
	...
	function get_placeholder_image($image_width = 24, $image_height = 24) {
		...
		$placeholder_color = \DMS\Helper\Utils::get_option('placeholder_color', '#555');
		...
		$svg = base64_encode(DMS()->View->load('/template-parts/lazy-loading-svg', $data, true));
	...
	public function load_assets() {
		wp_enqueue_script( 'lazy-load', DMS()->config['assets_uri'] . 'js/lazyload.js', array(), DMS()->config['cache_time'], true );
	}
