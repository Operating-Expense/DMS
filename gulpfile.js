...
var config = {
	theme: {
        name: 'DMS Theme',	// Change theme name
		prefix: 'DMS',		// Change theme prefix
		singleton: 'DMS',	// Change theme main class
		textdomain: 'dms',	// Change textdomain
		styles: 'dms',		// Change CSS styles refix
